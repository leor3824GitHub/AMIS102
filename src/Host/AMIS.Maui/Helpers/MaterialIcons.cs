namespace AMIS.Maui.Helpers;

/// <summary>
/// Glyph codepoints for the Material Symbols Outlined font (FontFamily "MaterialSymbols").
/// Values are \uXXXX escapes (never literal private-use characters - they are invisible
/// in editors and vulnerable to encoding corruption). Codepoints come from the font's
/// official .codepoints file - do not guess new values; look them up at
/// https://github.com/google/material-design-icons (variablefont/*.codepoints).
/// </summary>
