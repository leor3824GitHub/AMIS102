...
namespace AMIS.Playground.Migrations.PostgreSQL.AssetRegister
{
    ...
    [Migration("20260704122359_PhysicalCountEntryClientAssignedKey")]
    partial class PhysicalCountEntryClientAssignedKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.Issuance.PPEIRFormSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PPEIRFormSeries", "asset_register");
            ...
            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.Locations.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Locations", "asset_register");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.Receiving.PPERRFormSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PPERRFormSeries", "asset_register");
            ...
            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.Repairs.PropertyRepair", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("AmountPerJO")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<DateOnly?>("DateOfLastRepair")
                        .HasColumnType("date");

                    b.Property<string>("DvNo")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("NatureOfLastRepair")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("PartsToReplace")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("PoJoNo")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("PostInspectedBy")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<DateOnly?>("PostInspectedOn")
                        .HasColumnType("date");

                    b.Property<string>("PostInspectionFindings")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("PreInspectedBy")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<DateOnly?>("PreInspectedOn")
                        .HasColumnType("date");

                    b.Property<string>("PreInspectionFindings")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.HasIndex("TenantId", "AssetRegistryId");

                    b.HasIndex("TenantId", "RpriNo")
                        .IsUnique();

                    b.HasIndex("TenantId", "Status");

                    b.ToTable("PropertyRepairs", "asset_register");
                    ...
                    b.OwnsOne("AMIS.Modules.AssetRegister.Contracts.v1.ValueObjects.AssetSnapshot", "Snapshot", b1 =>
                        {
                            ...
                            b1.Property<decimal>("NetBookValue")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
            ...
            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.Locations.Location", b =>
                {
                    b.HasOne("AMIS.Modules.AssetRegister.Domain.Locations.Location", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AMIS.Modules.AssetRegister.Domain.ReturnedProperty.ReturnedPropertyReceipt", b =>
                {
                    b.OwnsOne("AMIS.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "AssignedInspector", b1 =>
                        {
                            ...
                            b1.Property<string>("Designation")
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("AssignedInspector_Designation");

                            b1.Property<Guid>("EmployeeId")
                                .HasColumnType("uuid")
                                .HasColumnName("AssignedInspector_EmployeeId");

                            b1.Property<string>("PrintedName")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("AssignedInspector_PrintedName");
