...
namespace AMIS.Playground.Migrations.PostgreSQL.BudgetDisbursement
{
    ...
    [Migration("20260717054427_UnifyNumberSequences")]
    partial class UnifyNumberSequences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMIS.Framework.Core.Domain.NumberSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "SequenceKey", "Year", "Month")
                        .IsUnique();

                    b.ToTable("NumberSequences", "budgetdisbursement");
                });
