...
namespace AMIS.Playground.Migrations.PostgreSQL.MultiTenancy
{
    ...
    [Migration("20260722130038_TenantOfficeLink")]
    partial class TenantOfficeLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMIS.Framework.Shared.Multitenancy.AppTenantInfo", b =>
                {
            ...
            modelBuilder.Entity("AMIS.Modules.Multitenancy.Domain.PlatformSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("AbsoluteTimeoutDays")
                    ...
                    b.ToTable("PlatformSettings", "tenant");
                });

            modelBuilder.Entity("AMIS.Modules.Multitenancy.Domain.TenantTheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMIS.Modules.Multitenancy.Provisioning.TenantProvisioning", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMIS.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMIS.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.HasOne("AMIS.Modules.Multitenancy.Provisioning.TenantProvisioning", "Provisioning")
                        .WithMany("Steps")
