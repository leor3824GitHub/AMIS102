...
// Lightweight read-only lookup over the AssetManagement locations endpoint
// (api/v1/asset-management/locations). Used by AssetRegister UIs that need to pick a
// location Guid (e.g. recording a physical-count found-at-station item). Requires the
// caller to hold AssetManagement Locations.View.
