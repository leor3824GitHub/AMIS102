...
namespace FSH.Playground.Migrations.PostgreSQL.AssetRegister
{
    ...
    [Migration("20260513024201_AddVehicleProfileToAccountabilityLine")]
    partial class AddVehicleProfileToAccountabilityLine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Accountability.PropertyAccountability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Accountability.PropertyAccountabilityLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Assets.AssetRegistry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Catalog.PropertyCodeCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Catalog.PropertyItemCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Counting.PhysicalCountSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Incidents.PropertyIncidentItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Incidents.PropertyIncidentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Issuance.PropertyIssuanceReportLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Accountability.PropertyAccountability", b =>
                {
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "IssuedBy", b1 =>
                        {
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Accountability.PropertyAccountabilityLine", b =>
                {
                    b.HasOne("FSH.Modules.AssetRegister.Domain.Accountability.PropertyAccountability", null)
                        .WithMany("Lines")
                        .HasForeignKey("AccountabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.AssetSnapshot", "Snapshot", b1 =>
                        {
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Counting.PhysicalCountEntry", b =>
                {
                    b.HasOne("FSH.Modules.AssetRegister.Domain.Counting.PhysicalCountSession", null)
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Counting.PhysicalCountSession", b =>
                {
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "ApprovedBy", b1 =>
                        {
                    ...
                    b.OwnsMany("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "ConductedBy", b1 =>
                        {
                            b1.Property<Guid>("PhysicalCountSessionId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "WitnessedBy", b1 =>
                        {
                            b1.Property<Guid>("PhysicalCountSessionId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Incidents.PropertyIncidentItem", b =>
                {
                    b.HasOne("FSH.Modules.AssetRegister.Domain.Incidents.PropertyIncidentReport", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Incidents.PropertyIncidentReport", b =>
                {
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "AccountableOfficer", b1 =>
                        {
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Issuance.PropertyIssuanceReport", b =>
                {
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "CertifiedBy", b1 =>
                        {
                    ...
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "PostedBy", b1 =>
                        {
                            b1.Property<Guid>("PropertyIssuanceReportId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "PreparedBy", b1 =>
                        {
                            b1.Property<Guid>("PropertyIssuanceReportId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Issuance.PropertyIssuanceReportLine", b =>
                {
                    b.HasOne("FSH.Modules.AssetRegister.Domain.Issuance.PropertyIssuanceReport", null)
                        .WithMany("Lines")
                        .HasForeignKey("ReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FSH.Modules.AssetRegister.Domain.Unserviceable.UnserviceablePropertyReport", b =>
                {
                    ...
                    b.OwnsOne("FSH.Modules.AssetRegister.Contracts.v1.ValueObjects.EmployeeRef", "InspectedBy", b1 =>
                        {
                            b1.Property<Guid>("UnserviceablePropertyReportId")
                                .HasColumnType("uuid");
