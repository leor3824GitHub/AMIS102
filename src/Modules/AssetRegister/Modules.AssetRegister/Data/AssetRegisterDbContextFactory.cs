...
public sealed class AssetRegisterDbContextFactory : IDesignTimeDbContextFactory<AssetRegisterDbContext>
{
    public AssetRegisterDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<AssetRegisterDbContext>();
        ...
        {
            throw new NotSupportedException($"Database provider '{provider}' is not supported for AssetRegisterDbContext migrations.");
        }
        ...
        return new AssetRegisterDbContext(
            tenantAccessor,
    ...
    private sealed class DesignTimeHostEnvironment : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = nameof(AssetRegisterDbContextFactory);
