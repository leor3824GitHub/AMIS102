...
public sealed class ArchiveChannelCommandHandler : ICommandHandler<ArchiveChannelCommand, Unit>
{
    private readonly ChatDbContext _dbContext;
    private readonly ICurrentUser _currentUser;

    public ArchiveChannelCommandHandler(ChatDbContext dbContext, ICurrentUser currentUser)
    {
        _dbContext = dbContext;
        _currentUser = currentUser;
    }

    public async ValueTask<Unit> Handle(ArchiveChannelCommand command, CancellationToken cancellationToken)
    {
