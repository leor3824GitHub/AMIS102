...
public sealed class BudgetDisbursementDbContextFactory : IDesignTimeDbContextFactory<BudgetDisbursementDbContext>
{
    public BudgetDisbursementDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<BudgetDisbursementDbContext>();
        ...
        {
            throw new NotSupportedException($"Database provider '{provider}' is not supported for BudgetDisbursementDbContext migrations.");
        }
        ...
        return new BudgetDisbursementDbContext(
            tenantAccessor,
    ...
    private sealed class DesignTimeHostEnvironment : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = nameof(BudgetDisbursementDbContextFactory);
