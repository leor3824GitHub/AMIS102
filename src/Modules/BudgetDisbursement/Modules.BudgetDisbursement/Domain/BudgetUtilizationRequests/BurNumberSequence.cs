...
/// <summary>
/// Tracks the last-issued serial for Budget Utilization Request numbers per fiscal year (BUR-YYYY-NNNNN).
/// One counter row per <see cref="Year"/>, guarded by PostgreSQL xmin optimistic concurrency. Keyed by year
/// only (not tenant) to match the global unique index on <c>BudgetUtilizationRequest.BurNumber</c>.
/// </summary>
