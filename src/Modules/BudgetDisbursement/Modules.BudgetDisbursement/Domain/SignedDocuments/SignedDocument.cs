...
namespace AMIS.Modules.BudgetDisbursement.Domain.SignedDocuments;

/// <summary>
/// The uploaded scanned wet-signed copy of a Budget Disbursement document of record (e.g. a Disbursement Voucher).
/// The file lives in object storage; this row holds the storage key plus a SHA-256 integrity hash and
/// upload audit. One current copy per (tenant, document) — re-uploading <see cref="Replace"/>s it.
/// </summary>
public sealed class SignedDocument : AggregateRoot<Guid>, IHasTenant, IAuditableEntity
{
    public string TenantId { get; private set; } = default!;
    public BudgetDisbursementDocumentType DocumentType { get; private set; }
