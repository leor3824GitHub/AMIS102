...
namespace AMIS.Modules.BudgetDisbursement.Contracts.v1.DisbursementVouchers;
...
// Commands
// A DV is raised against an obligated Budget Utilization Request. The purchase order, payee and amount
...
public sealed record DeleteDisbursementVoucherCommand(Guid Id) : ICommand;
