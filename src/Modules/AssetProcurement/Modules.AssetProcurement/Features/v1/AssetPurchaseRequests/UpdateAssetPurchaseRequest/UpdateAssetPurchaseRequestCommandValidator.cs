...
public sealed class UpdateAssetPurchaseRequestCommandValidator : AbstractValidator<UpdateAssetPurchaseRequestCommand>
{
    public UpdateAssetPurchaseRequestCommandValidator()
    {
