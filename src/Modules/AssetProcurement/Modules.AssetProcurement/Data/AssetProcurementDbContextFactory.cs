...
public sealed class AssetProcurementDbContextFactory : IDesignTimeDbContextFactory<AssetProcurementDbContext>
{
    public AssetProcurementDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<AssetProcurementDbContext>();
        ...
        {
            throw new NotSupportedException($"Database provider '{provider}' is not supported for AssetProcurementDbContext migrations.");
        }
        ...
        return new AssetProcurementDbContext(
            tenantAccessor,
    ...
    private sealed class DesignTimeHostEnvironment : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = nameof(AssetProcurementDbContextFactory);
