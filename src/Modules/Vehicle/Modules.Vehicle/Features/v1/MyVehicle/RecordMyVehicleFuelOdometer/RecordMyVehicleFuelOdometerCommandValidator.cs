...
public sealed class RecordMyVehicleFuelOdometerCommandValidator : AbstractValidator<RecordMyVehicleFuelOdometerCommand>
{
    public RecordMyVehicleFuelOdometerCommandValidator()
    {
