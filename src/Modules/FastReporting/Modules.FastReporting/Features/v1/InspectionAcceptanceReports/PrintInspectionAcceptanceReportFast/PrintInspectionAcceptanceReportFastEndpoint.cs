...
public static class PrintInspectionAcceptanceReportFastEndpoint
{
    private const string InspectionAcceptanceReportsView = "Permissions.Procurement.InspectionAcceptanceReports.View";

    public static RouteHandlerBuilder Map(this IEndpointRouteBuilder endpoints) =>
        endpoints.MapGet("/{id:guid}/print", PrintFast)
            .WithName("FastReporting_PrintInspectionAcceptanceReport")
            ...
            .RequirePermission(InspectionAcceptanceReportsView);
        ...
        int? minRows = null)
    {
        ...
        var dto = await mediator.Send(
            new PrintInspectionAcceptanceReportFastQuery(id, paperSize, orient, rows), ct);
