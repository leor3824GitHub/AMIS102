...
public static class PrintSMRRFastEndpoint
{
    ...
    public static RouteHandlerBuilder Map(this IEndpointRouteBuilder endpoints) =>
        endpoints.MapGet("/{id:guid}/print", PrintFast)
            .WithName("FastReporting_PrintSMRR")
            .WithSummary("Generate a FastReport PDF for an SMRR (Supplies and Materials Receiving Report)")
        ...
        int? minRows = null)
    {
        ...
        var dto = await mediator.Send(
            new PrintSMRRFastQuery(id, paperSize, orient, rows), ct);
