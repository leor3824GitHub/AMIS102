...
public sealed class CreateFundingSourceCodeCommandValidator : AbstractValidator<CreateFundingSourceCodeCommand>
{
    public CreateFundingSourceCodeCommandValidator()
    {
        RuleFor(x => x.Code)
