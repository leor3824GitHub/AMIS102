...
namespace AMIS.Modules.Finance.Domain.SignedDocuments;

/// <summary>
/// The uploaded scanned wet-signed copy of a Finance document of record (e.g. a Disbursement Voucher).
...
public sealed class SignedDocument : AggregateRoot<Guid>, IHasTenant, IAuditableEntity
{
    ...
    public FinanceDocumentType DocumentType { get; private set; }
