...
public sealed class RivNumberSequenceConfiguration : IEntityTypeConfiguration<RivNumberSequence>
{
    public void Configure(EntityTypeBuilder<RivNumberSequence> builder)
    {
        builder.ToTable("RivNumberSequences", ProcurementAcquisitionModuleConstants.SchemaName)
            .IsMultiTenant();
        ...
        // One counter row per (TenantId + Year) — RIV serials reset yearly.
