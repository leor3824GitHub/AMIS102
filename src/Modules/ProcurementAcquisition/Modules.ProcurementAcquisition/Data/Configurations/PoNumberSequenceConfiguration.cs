...
public sealed class PoNumberSequenceConfiguration : IEntityTypeConfiguration<PoNumberSequence>
{
    public void Configure(EntityTypeBuilder<PoNumberSequence> builder)
    {
        builder.ToTable("PoNumberSequences", ProcurementAcquisitionModuleConstants.SchemaName)
            .IsMultiTenant();
        ...
        // One counter row per (TenantId + Year + Month) — PO serials reset monthly.
