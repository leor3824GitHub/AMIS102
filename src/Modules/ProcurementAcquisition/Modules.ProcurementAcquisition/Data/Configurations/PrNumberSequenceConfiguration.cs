...
public sealed class PrNumberSequenceConfiguration : IEntityTypeConfiguration<PrNumberSequence>
{
    public void Configure(EntityTypeBuilder<PrNumberSequence> builder)
    {
        builder.ToTable("PrNumberSequences", ProcurementAcquisitionModuleConstants.SchemaName)
            .IsMultiTenant();
