...
namespace AMIS.Modules.ProcurementAcquisition.Domain.SignedDocuments;

/// <summary>
/// The uploaded scanned wet-signed copy of a procurement document of record (PR/PO/AoC). The file lives
...
public sealed class SignedDocument : AggregateRoot<Guid>, IHasTenant, IAuditableEntity
{
    ...
    public ProcurementDocumentType DocumentType { get; private set; }
