...
/// <summary>
/// Tracks the last-issued serial number for PR number generation per tenant and fiscal year.
...
/// </summary>
public sealed class PrNumberSequence : BaseEntity<Guid>, IHasTenant
{
    ...
    private PrNumberSequence() { }

    public static PrNumberSequence Create(string tenantId, int year) =>
