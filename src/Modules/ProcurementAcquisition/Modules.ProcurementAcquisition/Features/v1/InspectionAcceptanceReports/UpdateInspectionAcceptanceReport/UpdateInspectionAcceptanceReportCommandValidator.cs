...
public sealed class UpdateInspectionAcceptanceReportCommandValidator : AbstractValidator<UpdateInspectionAcceptanceReportCommand>
{
    public UpdateInspectionAcceptanceReportCommandValidator()
    {
