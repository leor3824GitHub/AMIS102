...
public sealed class SubmitIARForInspectionCommandHandler(
    ProcurementDbContext dbContext) : ICommandHandler<SubmitIARForInspectionCommand, InspectionAcceptanceReportDto>
{
    public async ValueTask<InspectionAcceptanceReportDto> Handle(SubmitIARForInspectionCommand command, CancellationToken cancellationToken)
    {
