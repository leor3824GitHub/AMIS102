...
public sealed class CreateInspectionAcceptanceReportCommandValidator : AbstractValidator<CreateInspectionAcceptanceReportCommand>
{
    public CreateInspectionAcceptanceReportCommandValidator()
    {
